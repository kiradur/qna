...
RSpec.describe AnswersController, type: :controller do
  ...
  describe 'POST #best' do
    context 'user is author of the question' do
      ...
      let!(:badge) { create(:badge, question: question, name: 'first reward', image: fixture_file_upload("#{Rails.root}/spec/fixtures/images/badge.png", 'image/png')) }
      ...
      it 'user should receive a reward' do
        expect { post :best, params: { id: answer }, format: :js }.to change(answer_author.badge, :count).by(1)
      end
